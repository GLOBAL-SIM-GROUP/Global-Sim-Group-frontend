# Compile le guide Clients en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/clients)
$tex = "clients.tex"
...
Write-Host "==> Termine : clients.pdf est a jour."
