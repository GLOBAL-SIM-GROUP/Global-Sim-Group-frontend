# Compile le guide Résidence en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation)
$tex = "residence.tex"
...
Write-Host "==> Termine : residence.pdf est a jour."
