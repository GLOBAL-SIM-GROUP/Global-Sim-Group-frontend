# Compile le guide Facturation en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/facturation)
$tex = "facturation.tex"
...
Write-Host "==> Termine : facturation.pdf est a jour."
