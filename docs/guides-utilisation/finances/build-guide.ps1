# Compile le guide Finances en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/finances)
$tex = "finances.tex"
...
Write-Host "==> Termine : finances.pdf est a jour."
