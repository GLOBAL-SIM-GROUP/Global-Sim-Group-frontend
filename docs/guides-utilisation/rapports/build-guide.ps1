# Compile le guide Rapports en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/rapports)
$tex = "rapports.tex"
...
Write-Host "==> Termine : rapports.pdf est a jour."
