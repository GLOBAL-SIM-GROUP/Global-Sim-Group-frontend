# Compile le guide Restaurant en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/restaurant)
$tex = "restaurant.tex"
...
Write-Host "==> Termine : restaurant.pdf est a jour."
