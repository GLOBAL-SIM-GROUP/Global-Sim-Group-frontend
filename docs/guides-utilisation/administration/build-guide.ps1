# Compile le guide Administration en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/administration)
$tex = "administration.tex"
...
Write-Host "==> Termine : administration.pdf est a jour."
