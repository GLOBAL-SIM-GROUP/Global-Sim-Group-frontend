# Compile le guide Salle de fête en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/salle-fete)
$tex = "salle-fete.tex"
...
Write-Host "==> Termine : salle-fete.pdf est a jour."
