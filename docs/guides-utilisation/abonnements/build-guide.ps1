# Compile le guide Abonnements en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/abonnements)
$tex = "abonnements.tex"
...
Write-Host "==> Termine : abonnements.pdf est a jour."
