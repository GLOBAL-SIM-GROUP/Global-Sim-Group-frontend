# Compile le guide RH en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/rh)
$tex = "rh.tex"
...
Write-Host "==> Termine : rh.pdf est a jour."
