...
- Les ventes : liste, statuts (Payée / En cours / Annulée), nouvelle vente
  (client optionnel, scan ou sélection de produit, remise, moyen de
  paiement obligatoire → statut Payée immédiat), facture, reçu imprimable,
  annulation admin.
