# Compile le guide Marchandise en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/marchandise)
$tex = "marchandise.tex"
...
Write-Host "==> Termine : marchandise.pdf est a jour."
