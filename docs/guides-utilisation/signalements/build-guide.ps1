# Compile le guide Signalements en 3 passages (table des matières + renvois).
# Usage : .\build-guide.ps1   (à lancer depuis le dossier docs/guides-utilisation/signalements)
$tex = "signalements.tex"
...
Write-Host "==> Termine : signalements.pdf est a jour."
