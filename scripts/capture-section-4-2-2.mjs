...
async function main() {
	...
	try {
		...
		// Liste des contrats vide (on va en créer un).
		...
		// Ouvre le formulaire « Nouveau contrat ».
		...
		console.log("✅ Section 4.2.2 capturée avec succès (logement existant, API simulée).");
	} finally {
		await browser.close();
	}
}
