 ...
 * création de passage inline), logement (cascade), dates/heures et tarif. En
 * édition : prestation, dates, tarif, statut.
 */
export function SejourForm({ sejour, onCancel, onSaved }: SejourFormProps) {
