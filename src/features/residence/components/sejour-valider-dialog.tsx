 ...
 * de substitution optionnel (omis = celui demandé par le client, conservé).
 *
							...
							{(field) => (
								<div className="space-y-2">
									...
									<p className="text-xs text-muted-foreground">
										Laisser vide pour conserver le logement demandé par le
										client ; choisissez-en un autre s'il n'est plus disponible.
									</p>
								</div>
							)}
						</form.Field>
