...
/**
 * Page « Connexion » (extraite de `routes/login.tsx` — un composant exporté
 * en plus de `Route` empêche TanStack Router de découper cette route dans
 * son propre chunk, voir l'avertissement "will not be code-split").
 */
export function LoginPage() {
	...
	return (
		<>
			...
			<main
				className="flex min-h-dvh items-center justify-center bg-gradient-to-br from-background via-lagoon/5 to-sea-ink/10 p-4 sm:p-6 relative overflow-hidden login-animated-bg"
				style={{
					backgroundImage: `
			...
			>
				...
				<div
					className="absolute bottom-0 right-0 w-96 h-96 pointer-events-none opacity-8 login-logo-bg"
					style={{
