...
/**
 * Page de détail d'une commande de pressing (portail résident) : statut,
 * progression des étapes et suivi du paiement (acompte / reste à payer).
 */
