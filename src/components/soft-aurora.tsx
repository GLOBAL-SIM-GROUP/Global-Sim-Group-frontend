...
/**
 * Adapté de React Bits — SoftAurora (variante TS). Dépendance : `ogl`.
 * Rend un aurore boréale douce en shader (bruit de Perlin 3D + dégradés
 * cosinus). `lightMode` produit un fond blanc traversé de bandes colorées,
 * adapté à une page à thème clair.
 */
...
export function SoftAurora({
	...
	useEffect(() => {
		...
		// Le canvas est pointer-events-none : on écoute la fenêtre pour garder
		// une légère parallaxe sur un fond de page.
